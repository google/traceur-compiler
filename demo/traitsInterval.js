...
class Interval {
  ...
  function toString() { return ''+this.start+'..!'+this.end; }
  function lessThan(ival) { return this.end <= ival.start; }
  function equals(ival) { return this.start == ival.start && this.end == ival.end; }
  function contains(e) { return (this.start <= e) && (e < this.end); }
