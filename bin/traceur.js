...
var $___src_syntax_trees_ParseTrees_js = (function() {
  ...
  var ImportDeclaration = function($__super) {
    ...
    var $ImportDeclaration = ($__createClass)({
      constructor: function(location, importBinding) {
        this.location = location;
  ...
  var ParseTreeTransformer = function() {
    ...
    var $ParseTreeTransformer = ($__createClassNoExtends)({
      ...
      transformImportDeclaration: function(tree) {
        var importBinding = this.transformAny(tree.importBinding);
        if (importBinding === tree.importBinding) {
          return tree;
        }
        return new ImportDeclaration(tree.location, importBinding);
      },
  ...
  var Parser = function() {
    ...
    var $Parser = ($__createClassNoExtends)({
      ...
      parseModule_: function(load) {
        ...
        return new ModuleDeclaration(this.getTreeLocation_(start), identifier, expression);
      },
  ...
  var ParseTreeValidator = function($__super) {
    ...
    var $ParseTreeValidator = ($__createClass)({
      ...
      visitExportDeclaration: function(tree) {
        ...
        this.checkVisit_(declType == VARIABLE_STATEMENT || declType == FUNCTION_DECLARATION || declType == MODULE_DEFINITION || declType == MODULE_DECLARATION || declType == CLASS_DECLARATION || declType == EXPORT_MAPPING, tree.declaration, 'expected valid export tree');
      },
      visitExportMapping: function(tree) {
        if (tree.moduleExpression) {
