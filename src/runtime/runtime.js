...
export function assertName(val) {
...
export var createName = NameModule.Name;
...
export function elementDelete(object, name) {
...
export function elementGet(object, name) {
  if (traceur.options.trapMemberLookup &&
...
export function elementHas(object, name) {
  // Should we allow trapping this too?
  return has(object, name);
}

export function elementSet(object, name, value) {
  if (traceur.options.trapMemberLookup &&
...
export function deleteProperty(object, name) {
...
export function getIterator(collection) {
