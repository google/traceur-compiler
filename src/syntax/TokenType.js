...
export var NEW = 'new';
export var NO_SUBSTITUTION_TEMPLATE = 'no substitution template';
...
export var TEMPLATE_HEAD = 'template head';
export var TEMPLATE_MIDDLE = 'template middle';
export var TEMPLATE_TAIL = 'template tail';
