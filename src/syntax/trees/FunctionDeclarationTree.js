...
traceur.define('syntax.trees', function() {
   ...
   * @extends {ParseTree}
   */
  function FunctionDeclarationTree(location, name, isStatic, formalParameterList, functionBody) {
    ParseTree.call(this, ParseTreeType.FUNCTION_DECLARATION, location);
    this.name = name;
  ...
  FunctionDeclarationTree.prototype = {
