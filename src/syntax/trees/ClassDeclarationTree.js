...
traceur.define('syntax.trees', function() {
   ...
   * @extends {ParseTree}
   */
  function ClassDeclarationTree(location, name, superClass, elements) {
    ParseTree.call(this, ParseTreeType.CLASS_DECLARATION, location);
    this.name = name;
    this.superClass = superClass;
    this.elements = elements;
  }

  ClassDeclarationTree.prototype = {
