...
traceur.define('syntax.trees', function() {
   ...
   * @extends {ParseTree}
   */
  function ForStatementTree(location, variables, condition, increment, body) {
    ParseTree.call(this, ParseTreeType.FOR_STATEMENT, location);
