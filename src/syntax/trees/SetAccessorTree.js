...
traceur.define('syntax.trees', function() {
   ...
   * @extends {ParseTree}
   */
  function SetAccessorTree(location, propertyName, isStatic, parameter, body) {
    ParseTree.call(this, ParseTreeType.SET_ACCESSOR, location);
  ...
  SetAccessorTree.prototype = {
    __proto__: ParseTree.prototype
  };

  return {
    SetAccessorTree: SetAccessorTree
  };
});
