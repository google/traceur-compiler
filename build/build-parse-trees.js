...
print("import {FunctionBaseTree} from './FunctionBaseTree';");
...
names.forEach(function(name) {
  ...
  var superClassName = 'ParseTree';
  if (paramNames[0] === 'extends') {
    superClassName = trees[name].extends;
    paramNames.shift();
  }

  print();
  print('var %s = ParseTreeType.%s;', treeTypeName, treeTypeName);
  print('export class %s extends %s {', name, superClassName);
  print('  /**');
