...
function createRegistryEntries(queryParams, opt_compilerOverrides) { 
  var registry = new goog.tweak.Registry(queryParams, opt_compilerOverrides || { }); 
  ...
  buttonEntry = new goog.tweak.ButtonAction('Button', 'The Btn', goog.nullFunction); 
  ...
  var nsBool = new goog.tweak.BooleanInGroupSetting('foo.bar.BoolOne', 'Desc for Namespaced 1', nsBoolGroup); 
