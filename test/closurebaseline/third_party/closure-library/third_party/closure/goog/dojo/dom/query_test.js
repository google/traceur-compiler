...
function testCorrectDocumentInFrame() { 
  ...
  frameDocument.body.innerHTML = document.getElementById('iframe-test').innerHTML; 
  ...
  assertNotEquals(document.getElementById('if3'), frameDocument.getElementById('if3')); 
} 
function assertQuery(expectedNumberOfNodes, var_args) { 
  var args = Array.prototype.slice.call(arguments, 1); 
  assertEquals(expectedNumberOfNodes, goog.dom.query.apply(null, args).length); 
} 
